...
export class Md2DateChange {
  constructor(public source: NewMD2Datepicker, public value: Date) { }
}
...
export class NewMD2Datepicker implements OnDestroy, ControlValueAccessor {
